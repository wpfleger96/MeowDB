...
class SoundResponse(SoundBase):
    ...
    title: str | None = None
    animal_uniqueness_score: float | None = None
    species_uniqueness_score: float | None = None
...
class StatsResponse(BaseModel):
    ...
    most_played: list[SoundSummary]
    recent: list[SoundSummary]
    most_upvoted: list[SoundSummary] = []
    most_downvoted: list[SoundSummary] = []
    label_counts: dict[str, int]
    first_sound_at: str | None = None
